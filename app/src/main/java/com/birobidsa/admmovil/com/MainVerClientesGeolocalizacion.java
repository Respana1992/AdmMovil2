...
@SuppressLint("NewApi")
public class MainVerClientesGeolocalizacion extends Activity {
	int textlength;
	String codigo,nombre,negocio,tipocli,observacion,codUser,nombreUsuario,tipoUsuario,txtCliente,selectClientes,numidcli, telfcli, celcli, latitudv, chbVisita;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_ver_clientes_geolocalizacion);
		...
		latitudv = getIntent().getStringExtra("latitudv");
		chbVisita = getIntent().getStringExtra("celC");
		...
		lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterView, View view, int i, long l)
			{
				...
				intent.putExtra("nombreUser", latitudv);
				intent.putExtra("nombreUser", chbVisita);
