...
@SuppressLint("NewApi")
public class MainVerItemEdicionPed extends Activity {
	double precio,precioItem,poruti,costop;
	int factor,stock,numprecio,secped,numped;
	boolean clienteitem;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_ver_item_edicion_ped);
		...
		secped=0; numped=0;
		secped = Integer.parseInt(getIntent().getStringExtra("secPedido"));
		numped = Integer.parseInt(getIntent().getStringExtra("numPedido"));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.main_ver_item_edicion_ped, menu);
		return true;
	}
