...
public class DetallesPedidosEdicion {
	int linea;
	int secuencial;
	String item;
	String nombreItem;
	...
	public DetallesPedidosEdicion()
	{
	}
	
	public DetallesPedidosEdicion(String item)
	{
		this.item=item;
	}
	
	public DetallesPedidosEdicion(int linea,int secuencial,String item,String nombre,int cajas,int unidades,int totalUnidades,double precio,
	...
	public DetallesPedidosEdicion(int linea,int secuencial,String item,int cajas,int unidades,int totalUnidades,
	...
	public DetallesPedidosEdicion(String item,String nombre,int cajas,int unidades,int totalUnidades,double precio,
						   double subtotal,double pordes,double descuento,double iva,double neto,String tipoItem,
