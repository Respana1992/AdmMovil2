...
public class DetallesPedidosB {
	...
	public DetallesPedidosB()
	{
	}

	public DetallesPedidosB(String item)
	{
		this.item=item;
	}

	public DetallesPedidosB(int linea, int secuencial, String item, String nombre, int cajas, int unidades, int totalUnidades, double precio,
                            double subtotal, double pordes, double descuento, double iva, double neto, String tipoItem,
                            String formaVta, String estado, String fechaIng, String horaIng, String usuario, String estadob)
	{
		this.linea=linea;
	...
	public DetallesPedidosB(int linea, int secuencial, String item, int cajas, int unidades, int totalUnidades,
                            ...
                            String usuario, String escambio, String estadob)
	{
		this.linea=linea;
		this.secuencial=secuencial;
		this.item=item;
	...
	public DetallesPedidosB(String item, String nombre, int cajas, int unidades, int totalUnidades, double precio,
                            double subtotal, double pordes, double descuento, double iva, double neto, String tipoItem,
                            String formaVta, String estado, String fechaIng, String horaIng, String usuario, String escambio, String estadob)
	{
		this.item=item;
		this.nombreItem=nombre;
		this.cajas=cajas;
