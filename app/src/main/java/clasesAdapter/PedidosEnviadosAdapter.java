...
public class PedidosEnviadosAdapter extends ArrayAdapter<Pedidos> {
	...
	public PedidosEnviadosAdapter(Context context, ArrayList<Pedidos> alpedido)
	{
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		View layoutPedido = inflater.inflate(R.layout.layout_list_view_ver_pedidos_enviados, parent,false);
